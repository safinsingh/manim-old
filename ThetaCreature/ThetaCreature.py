...
pi_creature_dir_maybe = os.path.join(MEDIA_DIR, "svg_images")
...
class ThetaCreature(SVGMobject):
    CONFIG = {
        "color": BLUE,
        "file_name_prefix": "ThetaCreature",
        "stroke_width": 0,
        "stroke_color": BLACK,
        "fill_opacity": 1.0,
        "height": 3,
    ...
    def align_data(self, mobject):
        ...
        if isinstance(mobject, ThetaCreature):
...
class ThetaCreatureSays(PiCreatureBubbleIntroduction):
    CONFIG = {
        "target_mode": "speaking",
        "bubble_class": SpeechBubble,
    }
