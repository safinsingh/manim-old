...
class Solving(Scene):
    def construct(self):
        ...
        eq5=TexMobject("\\frac{1}{8}p^{-1}m^{3}", "\\over 2pq^{2}")
        eq5_v2=TexMobject("\\frac{1}{8}", "p^{-1}m^{3} \\over", "2", "pq^{2}")
        eq6=TexMobject("p^{-1}m^{3} \\over", "16", "pq^{2}")
        eq6_v2=TexMobject("p^{-1}", "m^{3} \\over 16", "p", "q^{2}")
        eq7=TexMobject("m^{3} \\over 16", "p^{2}", "q^{2}")
